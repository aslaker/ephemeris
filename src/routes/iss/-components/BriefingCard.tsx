...
export function BriefingCard({
	...
	// Update status when briefing data changes from DB
	useEffect(() => {
		if (briefingLoading) {
			// Don't change status while initial DB load is happening
			return;
		}
	...
	const handleGenerate = useCallback(async () => {
		...
		try {
			...
			if (response.status === "success") {
				// Save to DB - reactive hook will update briefing data automatically
